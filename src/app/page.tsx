      ...
      <div className="container w-full h-full mx-auto">
        <div className="w-full h-1/2 flex flex-col gap-2 items-center justify-center">
          ...
          <div className="w-full max-w-5xl">
            <h2 className="text-5xl font-bold text-center leading-normal">mulai terhubung dengan pelanggan anda di dalam <mark className="bg-brush bg-transparent pb-6 inline-block">satu platform.</mark></h2>
          </div>
        </div>
